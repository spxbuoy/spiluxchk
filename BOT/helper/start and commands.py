...
𝐒𝐏𝐈𝐋𝐔✘ 𝐂𝐇𝐄𝐂𝐊𝐄𝐑 𝗛𝗮𝘀 𝗽𝗹𝗲𝗻𝘁𝘆 𝗼𝗳 𝗖𝗼𝗺𝗺𝗮𝗻𝗱𝘀. 𝗪𝗲 𝗛𝗮𝘃𝗲 𝗔𝘂𝘁𝗵 𝗚𝗮𝘁𝗲𝘀, 𝗖𝗵𝗮𝗿𝗴𝗲 𝗚𝗮𝘁𝗲𝘀, 𝗧𝗼𝗼𝗹𝘀, 𝗔𝗻𝗱 𝗢𝘁𝗵𝗲𝗿 𝗧𝗵𝗶𝗻𝗴𝘀.
...
𝐒𝐏𝐈𝐋𝐔✘ 𝐂𝐇𝐄𝐂
        ...
        # eleventh frame - eleventh letters
        text = """<b>
𝐒𝐏𝐈𝐋𝐔✘ 𝐂𝐇𝐄𝐂𝐊
      </b>"""
        await Client.edit_message_text(message.chat.id, edit.id, text)
        ...
        # twelveth frame - twelveth letters
        text = """<b>
𝐒𝐏𝐈𝐋𝐔✘ 𝐂𝐇𝐄𝐂𝐊𝐄
      </b>"""
        await Client.edit_message_text(message.chat.id, edit.id, text)
...
𝐒𝐏𝐈𝐋𝐔✘ 𝐂𝐇𝐄𝐂𝐊𝐄𝐑
        ...
        text = f"""
<b>💥 Yo <a href="tg://user?id={message.from_user.id}">{message.from_user.first_name}</b>,
 you just stepped into the motherfucking front line😈.

<b>⚡ This is <i>Spilu✘ Checker</i> — not your ordinary bot💀. I’m loaded, lethal, and here to wreck shit.</b>
...
𝗖𝗹𝗶𝗰𝗸 𝗼𝗻 𝗲𝗮𝗰𝗵 𝗼𝗳 𝘁𝗵𝗲𝗺 𝗯𝗲𝗹𝗼𝘄 𝘁𝗼 𝗴𝗲𝘁 𝘁𝗼  𝗸𝗻𝗼𝘄 𝘁𝗵𝗲𝗺 𝗯𝗲𝘁𝘁𝗲𝗿.</b>
    ...
    if CallbackQuery.data == "Auth2":
        CHARGE_TEXT = """
🔹 𝗦𝗧𝗥𝗜𝗣𝗘 𝗔𝗨𝗧𝗛 𝗚𝗔𝗧𝗘𝗦 𝗼𝗳 𝐒𝐏𝐈𝐋𝐔✘ 𝐂𝐇𝐄𝐂𝐊𝐄𝐑
🔹 𝗦𝘁𝗮𝘁𝘂𝘀: ✅ 𝗔𝗰𝘁𝗶𝘃𝗲
...
"""
    ...
    if CallbackQuery.data == "Adyen2":
        CHARGE_TEXT = """
🔹 𝗔𝗱𝘆𝗲𝗻 𝗔𝘂𝘁𝗵 𝗚𝗮𝘁𝗲𝘀 𝗼𝗳 𝐒𝐏𝐈𝐋𝐔✘ 𝐂𝐇𝐄𝐂𝐊𝐄𝐑
🔹 𝗦𝘁𝗮𝘁𝘂𝘀: 𝗔𝗰𝘁𝗶𝘃𝗲 ❌
...
"""
    ...
    if CallbackQuery.data == "BRAINTREEVBV":
        CHARGE_TEXT = """
🔹 𝗕𝗿𝗮𝗶𝗻𝘁𝗿𝗲𝗲 𝗚𝗮𝘁𝗲𝘀 𝗼𝗳 𝐒𝐏𝐈𝐋𝐔✘ 𝐂𝐇𝐄𝐂𝐊𝐄𝐑
🔹 𝗦𝘁𝗮𝘁𝘂𝘀: ✅ 𝗔𝗰𝘁𝗶𝘃𝗲
...
"""
    ...
    if CallbackQuery.data == "BRAINTREEB3":
        CHARGE_TEXT = """
🔹 𝗕𝗿𝗮𝗶𝗻𝘁𝗿𝗲𝗲 𝗔𝘂𝘁𝗵 𝗼𝗳 𝐒𝐏𝐈𝐋𝐔✘ 𝐂𝐇𝐄𝐂𝐊𝐄𝐑 
🔹 𝗦𝘁𝗮𝘁𝘂𝘀: ✅ 𝗔𝗰𝘁𝗶𝘃𝗲
...
"""
    ...
    if CallbackQuery.data == "SQUAREAUTH":
        CHARGE_TEXT = """
🔹 𝗦𝗾𝘂𝗮𝗿𝗲 𝗔𝘂𝘁𝗵 𝗚𝗮𝘁𝗲𝘀 𝗼𝗳 𝐒𝐏𝐈𝐋𝐔✘ 𝐂𝐇𝐄𝐂𝐊𝐄𝐑
🔹 𝗦𝘁𝗮𝘁𝘂𝘀: ❌ 𝗔𝗰𝘁𝗶𝘃𝗲
...
"""
    ...
    if CallbackQuery.data == "CLOVERAUTH":
        CHARGE_TEXT = """
🔹 𝗖𝗹𝗼𝘃𝗲𝗿 𝗔𝘂𝘁𝗵 𝗚𝗮𝘁𝗲𝘀 𝗼𝗳 𝐒𝐏𝐈𝐋𝐔✘ 𝐂𝐇𝐄𝐂𝐊𝐄𝐑
🔹 𝗦𝘁𝗮𝘁𝘂𝘀: ❌ 𝗔𝗰𝘁𝗶𝘃𝗲
...
𝗖𝗹𝗶𝗰𝗸 𝗼𝗻 𝗲𝗮𝗰𝗵 𝗼𝗳 𝘁𝗵𝗲𝗺 𝗯𝗲𝗹𝗼𝘄 𝘁𝗼 𝗴𝗲𝘁 𝘁𝗼 𝗸𝗻𝗼𝘄 𝘁𝗵𝗲𝗺 𝗯𝗲𝘁𝘁𝗲𝗿.</b>
    ...
    if CallbackQuery.data == "PAYPAL":
        CHARGE_TEXT = """
🔹 𝗣𝗮𝘆𝗣𝗮𝗹 𝗖𝗵𝗮𝗿𝗴𝗲 𝗚𝗮𝘁𝗲𝘀 𝗼𝗳 𝐒𝐏𝐈𝐋𝐔✘ 𝐂𝐇𝐄𝐂𝐊𝐄𝐑
🔹 𝗦𝘁𝗮𝘁𝘂𝘀: ❌ 𝗔𝗰𝘁𝗶𝘃𝗲
...
"""
    ...
    if CallbackQuery.data == "SKBASED":
        CHARGE_TEXT = """
🔹 𝗦𝗧𝗥𝗜𝗣𝗘 𝗖𝗵𝗮𝗿𝗴𝗲 𝗚𝗮𝘁𝗲𝘀 𝗼𝗳 𝐒𝐏𝐈𝐋𝐔✘ 𝐂𝐇𝐄𝐂𝐊𝐄𝐑
🔹 𝗦𝘁𝗮𝘁𝘂𝘀: ✅ 𝗔𝗰𝘁𝗶𝘃𝗲
...
"""
    ...
    if CallbackQuery.data == "SITE":
        CHARGE_TEXT = """
🔹 𝗦𝗶𝘁𝗲 𝗕𝗮𝘀𝗲𝗱 𝗔𝗽𝗶 𝗚𝗮𝘁𝗲𝘀 𝗼𝗳 𝐒𝐏𝐈𝐋𝐔✘ 𝐂𝐇𝐄𝐂𝐊𝐄𝐑
🔹 𝗦𝘁𝗮𝘁𝘂𝘀: ✅ 𝗔𝗰𝘁𝗶𝘃𝗲
...
"""
    ...
    if CallbackQuery.data == "BRAINTREE":
        CHARGE_TEXT = """
🔹 𝗕𝗿𝗮𝗶𝗻𝘁𝗿𝗲𝗲 𝗖𝗵𝗮𝗿𝗴𝗲 𝗚𝗮𝘁𝗲𝘀 𝗼𝗳 𝐒𝐏𝐈𝐋𝐔✘ 𝐂𝐇𝐄𝐂𝐊𝐄𝐑
🔹 𝗦𝘁𝗮𝘁𝘂𝘀: ❌ 𝗔𝗰𝘁𝗶𝘃𝗲
...
🔹 Shopify Charge Gates of 𝐒𝐏𝐈𝐋𝐔✘ 𝐂𝐇𝐄𝐂𝐊𝐄𝐑
🔹 Status: ✅ Active
...
"""
    ...
    if CallbackQuery.data == "AUTHNET":
        CHARGE_TEXT = """
🔹 Authnet Charge 𝗚𝗮𝘁𝗲𝘀 𝗼𝗳 𝐒𝐏𝐈𝐋𝐔✘ 𝐂𝐇𝐄𝐂𝐊𝐄𝐑
🔹 𝗦𝘁𝗮𝘁𝘂𝘀: ✅ 𝗔𝗰𝘁𝗶𝘃𝗲
...
"""
    ...
    if CallbackQuery.data == "SCRAPPER":
        CHARGE_TEXT = """
🔹 𝗦𝗰𝗿𝗮𝗽𝗽𝗲𝗿 𝗧𝗼𝗼𝗹𝘀 𝗚𝗮𝘁𝗲𝘀 𝗼𝗳 𝐒𝐏𝐈𝐋𝐔✘ 𝐂𝐇𝐄𝐂𝐊𝐄𝐑
🔹 𝗦𝘁𝗮𝘁𝘂𝘀: ✅ 𝗔𝗰𝘁𝗶𝘃𝗲
...
"""
    ...
    if CallbackQuery.data == "GENARATORTOOLS":
        CHARGE_TEXT = """
🔹 𝗚𝗲𝗻𝗲𝗿𝗮𝘁𝗼𝗿 𝗧𝗼𝗼𝗹𝘀 𝗼𝗳 𝐒𝐏𝐈𝐋𝐔✘ 𝐂𝐇𝐄𝐂𝐊𝐄𝐑
🔹 𝗦𝘁𝗮𝘁𝘂𝘀: ✅ 𝗔𝗰𝘁𝗶𝘃𝗲
...
"""
    ...
    if CallbackQuery.data == "BINANDOTHERS":
        CHARGE_TEXT = """
🔹 𝗕𝗶𝗻 𝗮𝗻𝗱 𝗢𝘁𝗵𝗲𝗿 𝗧𝗼𝗼𝗹𝘀 𝗢𝗳 𝐒𝐏𝐈𝐋𝐔✘ 𝐂𝐇𝐄𝐂𝐊𝐄𝐑
🔹 𝗦𝘁𝗮𝘁𝘂𝘀: ✅ 𝗔𝗰𝘁𝗶𝘃𝗲
