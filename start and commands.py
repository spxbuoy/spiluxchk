...
𝐒𝐏𝐈𝐋𝐔✘ 𝐂𝐇𝐄𝐂𝐊𝐄𝐑 Has plenty of Commands . We Have Auth Gates , Charge Gates , Tools And Other Things .
...
<b>Welcome aboard the 𝐒𝐏𝐈𝐋𝐔✘ 𝐂𝐇𝐄𝐂𝐊𝐄𝐑! 🚀</b>
...
Click on each one below to get to know them better. .</b>
    ...
    if CallbackQuery.data == "Auth2":
        CHARGE_TEXT = """
🔹 Stripe Auth Gates of 𝐒𝐏𝐈𝐋𝐔✘ 𝐂𝐇𝐄𝐂𝐊𝐄𝐑
🔹 Status: ✅ Active
...
"""
    ...
    if CallbackQuery.data == "Adyen2":
        CHARGE_TEXT = """
🔹 Adyen Auth Gates of 𝐒𝐏𝐈𝐋𝐔✘ 𝐂𝐇𝐄𝐂𝐊𝐄𝐑
🔹 Status: Inactive ❌
...
"""
    ...
    if CallbackQuery.data == "BRAINTREEVBV":
        CHARGE_TEXT = """
🔹 Braintree Gates of 𝐒𝐏𝐈𝐋𝐔✘ 𝐂𝐇𝐄𝐂𝐊𝐄𝐑
🔹 Status: ✅ Active
...
Click on each one below to get to know them better. .</b>
    ...
    if CallbackQuery.data == "PAYPAL":
        CHARGE_TEXT = """
🔹 PayPal Charge Gates of 𝐒𝐏𝐈𝐋𝐔✘ 𝐂𝐇𝐄𝐂𝐊𝐄𝐑
🔹 Status: ❌ Inactive
...
"""
    ...
    if CallbackQuery.data == "SKBASED":
        CHARGE_TEXT = """
🔹 Stripe Charge Gates of 𝐒𝐏𝐈𝐋𝐔✘ 𝐂𝐇𝐄𝐂𝐊𝐄𝐑
🔹 Status: ✅ Active
...
"""
    ...
    if CallbackQuery.data == "SITE":
        CHARGE_TEXT = """
🔹 Site Charge Gates of 𝐒𝐏𝐈𝐋𝐔✘ 𝐂𝐇𝐄𝐂𝐊𝐄𝐑
🔹 Status: ✅ Active
...
"""
    ...
    if CallbackQuery.data == "BRAINTREE":
        CHARGE_TEXT = """
🔹 Braintree Charge Gates of 𝐒𝐏𝐈𝐋𝐔✘ 𝐂𝐇𝐄𝐂𝐊𝐄𝐑
🔹 Status: ✅ Active
...
"""
    ...
    if CallbackQuery.data == "SCRAPPER":
        CHARGE_TEXT = """
🔹 Scrapper Tools Gates of 𝐒𝐏𝐈𝐋𝐔✘ 𝐂𝐇𝐄𝐂𝐊𝐄𝐑
🔹 Status: ✅ Active
...
"""
    ...
    if CallbackQuery.data == "GENARATORTOOLS":
        CHARGE_TEXT = """
🔹 Generator Tools of 𝐒𝐏𝐈𝐋𝐔✘ 𝐂𝐇𝐄𝐂𝐊𝐄𝐑
🔹 Status: ✅ Active
...
"""
    ...
    if CallbackQuery.data == "BINANDOTHERS":
        CHARGE_TEXT = """
🔹 Bin and Other Tools Of 𝐒𝐏𝐈𝐋𝐔✘ 𝐂𝐇𝐄𝐂𝐊𝐄𝐑
🔹 Status: ✅ Active
